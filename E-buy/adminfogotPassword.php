...
<div class="inputBox-fpw mt-4">
    ...
    <input type="text" required="required" id="e" class="p-2">
    <span>Email Address</span>
    <i></i>

</div>

<button class="button mt-3 p-1" onclick="adminforgotPassword();">Send Verification Code</button>
    ...
    <button class="button mt-3 p-1" onclick="adminresetPassword();">Change Password</button>
