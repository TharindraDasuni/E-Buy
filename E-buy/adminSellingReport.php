...
if (isset($_SESSION["a"])) {
    ...
    $rs =  Database::search("SELECT `invoice`.`id`,`invoice`.`order_id`,`product`.`title`,`invoice`.`date`,
    `user`.`fname`,`user`.`lname`,`invoice`.`total`,`invoice`.`qty` FROM `invoice` INNER JOIN `product` ON
        ...
        <div class="container" id="page">
            ...
            <div class="col-12 mt-3 mt-lg-4 text-item bg-light p-5">
                <h2 class="text-center  text-dark">
                    <link rel="icon" href="resource\logob.svg" />Selling Report
                </h2>

                <table class="table border border-2 border-dark table-hover mt-5 mb-5">
